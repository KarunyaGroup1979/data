                 ...
                 <div class='main_header_elements container'>
                   ...
                   <div class='blog-name'>
                     <b:section id='header' name='Header' showaddelement='false'>
                       <b:widget id='Header1' locked='true' title='Data Kawach (Header)' type='Header' visible='true'>
                         <b:widget-settings>
               ...
               <nav role='navigation'>
                 <b:section class='centered-top-secondline' id='page_list_top' name='Page List (Top)' showaddelement='false'>
                   <b:widget id='PageList1' locked='true' title='' type='PageList' visible='false'>
                     <b:widget-settings>
                       <b:widget-setting name='pageListJson'><![CDATA[{"home":{"href":"http://datakawach.blogspot.com/","position":0,"title":"Home"}}]]></b:widget-setting>
                 ...
                 <b:include cond='data:posts.any' data='{                                postDisplay: data:postDisplay,                                post: data:posts.first                              }' name='heroPost'/>
                         ...
                         <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' visible='true'>
                           <b:widget-settings>
                             ...
                             <b:widget-setting name='style.textcolor'>#25a186</b:widget-setting>
                             <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                             <b:widget-setting name='showCommentLink'>true</b:widget-setting>
                             <b:widget-setting name='style.urlcolor'>#e5f0ee</b:widget-setting>
      ...
      <aside class='sidebar-container sidebar-invisible' role='complementary'>
         ...
         <b:section class='sidebar' id='sidebar' name='Sidebar' preferred='yes'>
            <b:widget id='Profile1' locked='false' title='About Me' type='Profile' visible='true'>
               ...
               <b:includable id='userLocation'>
                  <dd class='profile-data profile-location'>
                     <data:location/>
                  </dd>
               </b:includable>
